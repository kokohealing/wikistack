...
module.exports = () => layout(html`
  ...
  <form method="POST" action="/wiki/">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <input id="status" name="status" type="checkbox" value="open" class="form-control"/>Open
        <input id="status" name="status" type="checkbox" value="closed" class="form-control"/>Closed
      </div>
    </div>
